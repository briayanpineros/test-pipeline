 ...
 *
 * @RestResource(
 *   id = "news_content_data_rest_api_lang",
 *   label = @Translation("News Export API (Lang)"),
 *   uri_paths = {
 *     "canonical" = "/api/news/{id}/{lang}"
 *   }
 * )
 */

class NewsContentDataRestApiLang extends ResourceBase
{
