 ...
 *
 * @RestResource(
 *   id = "news_list_content_data_rest_api_lang",
 *   label = @Translation("News List Export API (Lang)"),
 *   uri_paths = {
 *     "canonical" = "/api/news-list/{lang}"
 *   }
 * )
 */

class NewsListContentDataRestApiLang extends ResourceBase
{
  /**
