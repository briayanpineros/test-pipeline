 ...
 *
 * @RestResource(
 *   id = "totems_rest_resource",
 *   label = @Translation("Totems Configuration Data"),
 *   uri_paths = {
 *     "canonical" = "/services/totems-configuration"
 *   }
 * )
 */
class TotemsRestResource extends ResourceBase {
